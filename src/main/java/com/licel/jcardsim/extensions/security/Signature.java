...
public abstract class Signature {
    ...
    /**
     * Signature algorithm <CODE>ALG_ECDSA_SHA_256</CODE> generates a 32-bytes
     * SHA-256 digest and signs/verifies the digest using ECDSA.  The signature is encoded as an ASN.1
     * sequence of two INTEGER values, r and s, in that order:
     * SEQUENCE ::= { r INTEGER, s INTEGER }
     */
